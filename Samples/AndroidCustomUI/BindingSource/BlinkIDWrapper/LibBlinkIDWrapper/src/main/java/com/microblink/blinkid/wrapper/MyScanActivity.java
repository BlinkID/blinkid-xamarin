...
public final class MyScanActivity extends Activity implements ScanResultListener, CameraEventsListener, OnSizeChangedListener, OnActivityFlipListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recognizerBundle = RecognizerBundle.createFromIntent(getIntent());
    ...
    private void enableTorchButtonIfPossible() {
        ...
        mTorchEnabled = false;
        mTorchButton.setImageResource(R.drawable.ic_flash_off_24dp);
            ...
            public void onOperationDone(final boolean success) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (mTorchEnabled) {
                            mTorchButton.setImageResource(R.drawable.ic_flash_on_24dp);
                        } else {
                            mTorchButton.setImageResource(R.drawable.ic_flash_off_24dp);
                        }
                    }
