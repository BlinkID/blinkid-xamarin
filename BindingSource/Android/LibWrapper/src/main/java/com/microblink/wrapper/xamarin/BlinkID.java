...
public class BlinkID {
    ...
    private static final String BARCODE_TYPE_KEY = "Type";
    private static final String BARCODE_DATA_KEY = "Data";
    private static final String BARCODE_RAW_DATA_KEY = "Raw";

    // result types
    private static final String PDF417_RESULT_TYPE = "PDF417";
    private static final String USDL_RESULT_TYPE = "USDL";
    private static final String BARDECODER_RESULT_TYPE = "Barcode";
    private static final String ZXING_RESULT_TYPE = BARDECODER_RESULT_TYPE;
    private static final String MRTD_RESULT_TYPE = "MRTD";
    private static final String EUDL_RESULT_TYPE = "EUDL";
    private static final String MYKAD_RESULT_TYPE = "MyKad";
    ...
    private Intent buildScanIntent(RecognitionSettings settings) {
        ...
        final Intent intent = new Intent(mContext, ScanCardWrapper.class);
...
//        intent.putExtra(ScanActivity.EXTRAS_HELP_INTENT, helpIntent);
        ...
        intent.putExtra(ScanActivity.EXTRAS_LICENSE_KEY, mLicenseKey);
        ...
        intent.putExtra(ScanCard.EXTRAS_RECOGNITION_SETTINGS, mRecognitionSettings);
